...
def create_claims_dimension_scd2(**context):
    ...
    try:
        ...
        from backend.advanced_data_modeling import DeltaLakeManager, DataModelConfig, TableFormat, SCDType
        ...
        if not spark.catalog._existsTable("claims"):
            ...
            delta_table = delta_manager.create_delta_table(claims_with_audit, config)
        else:
            # Apply SCD Type 2
...
def optimize_delta_tables(**context):
    ...
    from backend.advanced_data_modeling import create_spark_session_with_lakehouse, DeltaLakeManager, DataModelConfig, TableFormat, SCDType
