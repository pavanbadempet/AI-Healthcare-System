...
export const intelligenceItems: MenuItem[] = [
  {
    ...
    href: "/chat",
    icon: MessageSquare,
    desc: "Generative search & RAG medical assistant",
    longDesc:
      "Query internal patient records, cross-reference clinical guidelines databases, and summarize diagnostic notes using secure local-first private LLM enclaves.",
    ...
    highlights: ["Clinical Query RAG", "Context Retrieval", "Secure Sandbox"],
    subActions: [
      { title: "Open Co-Pilot", href: "/chat" },
    ],
  },
  {
    id: "architecture",
    ...
    href: "/about",
    icon: Info,
    desc: "Deployment blueprints & platform specs",
    longDesc:
      "Inspect on-premises deployment configurations, HL7/FHIR connection gateway maps, and local PySpark Medallion data warehouse schemas.",
    color: "text-blue-400",
    bg: "bg-blue-500/10",
