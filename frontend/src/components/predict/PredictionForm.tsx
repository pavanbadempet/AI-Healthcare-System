                ...
                {(result.confidence !== undefined || result.probability !== undefined) && (
                  <div className="p-3 bg-[rgba(255,255,255,0.015)] border border-[var(--border)] rounded">
                    <div className="flex justify-between items-end mb-2">
                      <Tooltip content="The model's probability of disease presence (the positive class). If the output is Healthy, a lower probability indicates higher confidence in the negative classification." position="top-left">
                    ...
                    {result.risk_level && (
                      <div className="flex items-center gap-1.5 mt-2.5">
                        <Tooltip content="Medical urgency classification based on the predicted probability of risk: Low, Moderate, or High." position="top-left">
                ...
                {result.clinical_indices && (
                  <div className="space-y-4 border border-[var(--border)] rounded p-4 bg-zinc-950/40">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[10px] font-mono uppercase">
                      <div>
                        <Tooltip content="The set of statistically plausible labels generated by the conformal prediction framework. A single label indicates high model certainty." position="top-left">
                      ...
                      <div>
                        <Tooltip content="Indicates whether the model is highly decisive (Low Uncertainty) or if the prediction is ambiguous/unclear." position="top-left">
                      ...
                      <div className="sm:col-span-2">
                        <Tooltip content="The error rate threshold used by the conformal prediction algorithm to filter out unlikely labels. Adaptive α controls set size dynamically." position="top-left">
