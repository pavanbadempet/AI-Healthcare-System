...
jest.mock('@/lib/api', () => ({
  ...
  createDepartment: jest.fn(() => Promise.resolve({ id: 2, name: 'Emergency', department_type: 'Emergency', location: 'Ground', status: 'active', created_at: '2026-05-26T10:01:00Z' })),
  createBed: jest.fn(() => Promise.resolve({ id: 4, department_id: 1, bed_number: 'ICU-01', ward: 'ICU', status: 'available', current_patient_id: null, created_at: '2026-05-26T10:02:00Z' })),
}));
