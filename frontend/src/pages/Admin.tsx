...
import { Users, Activity, FileText, Database, ShieldAlert, CheckCircle2, ShieldCheck, Search, Calendar, Terminal, Network, Info, ArrowUpRight, Shield, RefreshCw, BarChart3, HelpCircle, Loader2 } from "lucide-react";
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<"users" | "hospital" | "audit" | "data-engineering">("users");
