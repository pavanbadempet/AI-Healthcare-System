    ...
    if (isAudioMode) {
      ...
      if (SpeechRecognition) {
        ...
        recognitionRef.current.onresult = (event: any) => {
          ...
          // Auto send after 1 second to feel like a real conversational agent
          setTimeout(() => {
            const form = document.getElementById('casa-chat-form') as HTMLFormElement;
        ...
        recognitionRef.current.onend = () => {
          if (isAudioMode) recognitionRef.current?.start(); // Keep listening if mode is still on
        };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="panel flex flex-col h-[520px] overflow-hidden">
              ...
              {/* Input Form */}
              <form id="casa-chat-form" onSubmit={handleSendMessage} className="p-4 border-t border-[var(--border)] bg-zinc-950/40 relative">
                <input 
                  type="text"
                  value={inputMessage}
              ...
              <div className="divide-y divide-[var(--border)]" role="list" aria-label="Active telemedicine encounters">
                {loading ? (
                  ...
                  activeAppts.map(apt => {
                    ...
                    return (
                      <div key={apt.id}>
                      <div className="p-4 hover:bg-[rgba(255,255,255,0.01)] transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4" role="listitem">
                        ...
                        <div className="flex flex-col gap-2 w-full sm:w-auto">
                          <div className="flex items-center gap-2 self-end">
                            ...
                            {activeVideoApt !== apt.id && (
                              <button
                                onClick={() => setActiveVideoApt(apt.id)}
