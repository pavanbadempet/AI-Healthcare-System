...
export default function ChatCopilotPage() {
  ...
  return (
    <div className="w-full h-[calc(100dvh-3.5rem)] flex bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-[var(--accent)] selection:text-white pb-6 pt-4">
      <div className="w-full max-w-[1800px] mx-auto flex gap-4 h-full px-4 md:px-8">
        ...
        <div className="flex-1 flex flex-col panel relative overflow-hidden">
          ...
          <div className="panel-header flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mono-meta mt-0.5">LLM ARCHITECTURE v4.2 | LATENCY: 34ms</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button 
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6" role="log" aria-label="Chat messages" aria-live="polite">
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center opacity-50">
                ...
                <p className="text-sm text-[var(--text-dim)] font-mono mt-2 max-w-md">Connect to FHIR data streams, query patient telemetry, or run diagnostic models.</p>
          ...
          <div className="p-4 bg-[var(--bg-secondary)] border-t border-[var(--border)]">
            ...
            <div className="max-w-4xl mx-auto mt-2 flex justify-between items-center mono-meta">
              <span className="flex items-center gap-1"><ShieldAlert size={10} aria-hidden="true" /> PHI PROTECTED. NO DATA LOGGED EXTERNALLY.</span>
              ...
              <div className="p-5 space-y-6 flex-1 overflow-y-auto">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2" role="radiogroup" aria-label="RAG data context scope">
                    {[
                      { id: 'all', label: 'Global DB & Literature', icon: Database },
                ...
                <div className="space-y-3 pt-4 border-t border-[var(--border)]">
                  ...
                  <div className="bg-[var(--bg-card)] border border-[var(--border)] p-3 text-[11px] font-mono text-[var(--text-secondary)] space-y-2">
                    <div className="flex justify-between">
                      <span>LLM:</span>
                      <span className="text-[var(--text-primary)]">GPT-4-Turbo-Med</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Temp:</span>
                      <span className="text-[var(--text-primary)]">0.1 (Strict)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Embeddings:</span>
                      <span className="text-[var(--success)]">Online (768d)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Vector DB:</span>
                ...
                <div className="bg-[var(--bg-card)] border border-[var(--border)] p-3 flex gap-3 text-[11px] font-mono text-[var(--text-dim)] leading-relaxed">
                  ...
                  <p>All queries are strictly sandboxed. The AI Copilot uses retrieval-augmented generation (RAG) to ensure evidence-based responses from hospital guidelines and specific patient EHRs.</p>
                </div>
              </div>
            </motion.div>
          )}
