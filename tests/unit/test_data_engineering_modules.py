...
from backend.schema_contracts import SchemaContract, ContractRegistry, contract_registry
from backend.schema_drift_detector import SchemaDriftDetector, schema_drift_detector
from backend.data_retention import DataRetentionManager, RetentionPolicy
from backend.duckdb_client import DuckDBClient, get_duckdb_client
from backend.delta_lake_integration import DeltaTableConfig, DeltaTableType, DeltaSchemaManager, HealthcareDeltaManager
from backend.feature_store_client import feature_store_client, FeatureStoreClient
...
def test_delta_lake_integration():
    ...
    with patch("backend.delta_lake_integration.DeltaTable.forPath", create=True) as mock_delta_table:
