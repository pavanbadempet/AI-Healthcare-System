...
def test_create_appointment_success(client, db_session):
    pat_user = _create_user(db_session, "appt_patient", "patient", facility_id=1)
...
def test_get_doctors(client, db_session):
    pat_user = _create_user(db_session, "appt_patient3", "patient", facility_id=1)
...
def test_create_appointment_past_date(client, db_session):
    pat_user = _create_user(db_session, "appt_patient4", "patient", facility_id=1)
