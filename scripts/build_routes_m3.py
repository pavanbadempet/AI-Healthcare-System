...
routes_dir = os.path.join("rust_gateway", "src", "routes")
os.makedirs(routes_dir, exist_ok=True)

def write_route_file(filename, content):
...
# 1. mod_common.rs
# =====================================================================
write_route_file("mod_common.rs", r'''
...
pub fn extract_claims(auth_header: &str, secret: &str) -> Result<Claims, StatusCode> {
    ...
    validation.validate_exp = false; // Permissive validation for test tokens
